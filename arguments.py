...
def get_args():
    ...
    parser.add_argument('--alpha', type=float, default=0.3, help='KD convex combination.')
    ...
    parser.add_argument('--schedule', type=int, nargs='+', default=[100,120,140],
    ...
    parser.add_argument('--epochs-class', type=int, default=150, help='Number of epochs for each increment')
